...
Version  : 2
Release  : 2
URL      : https://github.com/clearlinux/vbox-integration/archive/v2.tar.gz
Source0  : https://github.com/clearlinux/vbox-integration/archive/v2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1553033497
